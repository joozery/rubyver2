...
const StocksWhyTrade = () => {
    const reasons = [
        ...
        { icon: iconCfd, title: "GLOBAL STOCKS", desc: "Access hundreds of top-performing global stocks." },
            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="text-center mb-16">
                    <h2 className="text-[32px] lg:text-[64px] font-black uppercase tracking-tight leading-none">
                        <span className="text-white">WHY TRADE STOCKS</span> <br />
                        <span className="text-[#10b981]">WITH RUBY?</span>
                    </h2>
                </div>
