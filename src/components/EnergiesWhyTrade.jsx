...
const EnergiesWhyTrade = () => {
    const reasons = [
        ...
        { icon: iconCfd, title: "ENERGY COMMODITIES", desc: "Trade Oil, Gas, and more with competitive conditions." },
            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="text-center mb-16">
                    <h2 className="text-[32px] lg:text-[64px] font-black uppercase tracking-tight leading-none">
                        <span className="text-white">WHY TRADE ENERGIES</span> <br />
                        <span className="text-[#FF4500]">WITH RUBY?</span>
                    </h2>
                </div>
...
export default EnergiesWhyTrade;
