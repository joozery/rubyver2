...
const EnergiesSpreads = () => {
    const spreadData = [
        { asset: "USOIL", desc: "WTI Crude Oil", min: "0.03", typ: "0.04", cur: "0.03", size: "100", long: "-18.5", short: "-2.5" },
        { asset: "UKOIL", desc: "Brent Crude Oil", min: "0.04", typ: "0.05", cur: "0.04", size: "100", long: "-15.0", short: "-1.0" },
        { asset: "NGAS", desc: "Natural Gas", min: "0.006", typ: "0.010", cur: "0.008", size: "1000", long: "-12.0", short: "4.0" },
    ];
...
export default EnergiesSpreads;
