...
const StocksSpreads = () => {
    const spreadData = [
        { asset: "AAPL", desc: "Apple Inc.", min: "0.08", typ: "0.10", cur: "0.09", size: "1", long: "-5.0", short: "0.5" },
        { asset: "TSLA", desc: "Tesla Inc.", min: "0.15", typ: "0.20", cur: "0.18", size: "1", long: "-6.0", short: "0.2" },
        { asset: "AMZN", desc: "Amazon.com Inc.", min: "0.12", typ: "0.15", cur: "0.14", size: "1", long: "-5.5", short: "0.3" },
        { asset: "GOOGL", desc: "Alphabet Inc.", min: "0.10", typ: "0.12", cur: "0.11", size: "1", long: "-5.0", short: "0.4" },
        { asset: "MSFT", desc: "Microsoft Corp.", min: "0.09", typ: "0.11", cur: "0.10", size: "1", long: "-4.8", short: "0.6" },
    ];
