...
import iconCfd from '../assets/forex/iconforex/CFD.svg'; // Reuse or specific metals icon
...
const MetalsWhyTrade = () => {
    const reasons = [
        ...
        {
            icon: iconCfd,
            title: "PRECIOUS METAILS CFDS",
            desc: "Get access to global metals markets like Gold and Silver, tight spreads, and fast execution."
        },
        {
            icon: iconTrading,
            ...
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-[32px] lg:text-[64px] font-black uppercase tracking-tight leading-none">
                        <span className="text-white">WHY TRADE METALS</span> <br />
