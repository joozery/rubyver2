            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="text-center mb-16">
                    <h2 className="text-[32px] lg:text-[48px] font-black uppercase text-black tracking-tight flex items-center justify-center gap-3">
                        YOUR FUNDS ARE <span className="text-[#FFA500]">SECURE</span>
                    </h2>
                </div>
                ...
                <div className="text-center">
                    <button className="bg-[#FF4500] text-white px-16 py-4 rounded-md font-bold text-lg hover:bg-[#CC3700] transition-all uppercase shadow-lg hover:shadow-xl hover:-translate-y-1">
                        Start trading
                    </button>
                </div>
            </div>
...
export default EnergiesFundsSecure;
