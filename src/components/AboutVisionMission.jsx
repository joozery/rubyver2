            ...
            <div className="container mx-auto space-y-6">
                ...
                <div className="border border-white/15 rounded-2xl p-10 flex flex-col sm:flex-row items-center gap-10 min-h-[280px]">
                    ...
                    <div className="flex-1">
                        <h2 className="text-white font-black text-[45px] uppercase mb-5">
                            OUR VISION
                        </h2>
                        <p className="text-white/70 text-[27px] leading-relaxed mb-4">
                        ...
                        <p className="text-white/70 text-[27px] leading-relaxed">
                ...
                <div className="flex justify-center pt-6">
                    <button className="bg-red-600 hover:bg-red-700 text-white font-black text-sm uppercase tracking-widest w-[240px] py-4 rounded-lg transition-colors">
                        JOIN RUBY
                    </button>
                </div>
